...
public class Adapter_Recycler_VeMB_cxn_user extends RecyclerView.Adapter<Adapter_Recycler_VeMB_cxn_user.ViewHolder> {
    ArrayList<VeMB> list;
    Context context;

    public Adapter_Recycler_VeMB_cxn_user(ArrayList<VeMB> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(inflater.inflate(R.layout.layout_item1_vmb_cxn_user, parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            img = itemView.findViewById(R.id.logo_mb_cxn_user);
            tvmacb = itemView.findViewById(R.id.tv_macb_cxn_user);
            tvfrom = itemView.findViewById(R.id.tv_from_cxn_user);
            tvto = itemView.findViewById(R.id.tv_to_cxn_user);
            tvtimebay = itemView.findViewById(R.id.tv_timebay_cxn_user);
        }
    }
}
