...
public class Adapter_Recycler_tcxnvmb_staff extends RecyclerView.Adapter<Adapter_Recycler_tcxnvmb_staff.ViewHolder> {
    ArrayList<VeMB> list;
    Context context;

    public Adapter_Recycler_tcxnvmb_staff(ArrayList<VeMB> list, Context context) {
        this.list = list;
