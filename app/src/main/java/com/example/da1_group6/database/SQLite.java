...
public class SQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tb_nv = "create table NHANVIEN (manv text primary key, tennv text, email text, gioitinh integer, quoctich text, chucvu text, matkhau text, image blob)";
        String tb_kh = "create table KHACHHANG (makh text primary key, tenkh text, ngaysinh text, email text, sdt text, cccd text, gioitinh integer, diachi text, quoctich text, matkhau text, image blob)";
